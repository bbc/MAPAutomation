...
public class SMPAndroidOnDemandAudioPlayback {
	...
	public void openVpidBrowser() throws Exception {
		...
		try {
			...
			// commonobjects.vpid_enter, commonobjects.Audio_Vpid, "Audio",
			// commonobjects.vpid_load, driver,
			// ScreenshotPath);

			commonfunction.selectItemforPlayback(commonobjects.audioEpisode, "OnDemad Audio Programme",
	...
	// @Test(dependsOnMethods = { "audioPlayback" })
	...
	// Thread.sleep(4000);
	//
	// commonobjects.notificationtitle =
	// commonobjects.notification_title.getText();
	//
	// System.out.println("title name under notification :- " +
	// commonobjects.notificationtitle);
	// //
	//
	// commonobjects.notificationSutitle =
	// commonobjects.notification_Subtitle.getText();
	//
	// System.out.println("Station name under notification:- " +
	// commonobjects.notificationSutitle);
	//
	// Assert.assertEquals(commonobjects.notificationSutitle,
	// commonobjects.notification_Subtitle.getText());
	//
	...
	public void audioPlaying() throws Exception {
	 ...
	 ondemandobjects.vod_play_elasped_duration,
	...
	@Test(dependsOnMethods = { "audioPlaying" })
	public void PlaybackRotation() throws Exception {
		...
		try {
			...
			// commonobjects.transportControls.click();
			// Thread.sleep(3000);
	...
	@Test(dependsOnMethods = { "CheckPlayback_retry" })
